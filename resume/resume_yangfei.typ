...
#import "secrets.typ": fei_phone_number

#show: resume.with(
  author: (
    firstname: "YangFei (Fei)",
    lastname: "Zhou",
    email: "c.yangfeizhou@gmail.com",
    phone: fei_phone_number,
...
#resume-entry(
  title: "Category Owner/Supply Planner (McDonald’s Account), HAVI",
  location: "Downers Grove, IL",
  date: "Nov. 2017 – Mar. 2023",
...
#resume-entry(
  title: "Inventory Analyst, Sears Holding Corp.",
  location: "Hoffman Estates, IL",
  date: "Feb. 2015 – Jun. 2016",
  description: "Merchandise and services retailer that offers recognizable brands such as Kenmore and DieHard",
)
