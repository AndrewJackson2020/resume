...
\name{Andrew}{Jackson}
\address{Forest Park, IL 60130}{}{}
\phone[mobile]{1(847)380-0864}  
...
\begin{document}
	...
	\section{Experience}
		...
		\cventry{2022--Present}{Enfusion}{Lead Software Engineer}{}{}{}
		\begin{itemize}
		...
		\cventry{2018--2022}{Invesco}{Software Engineer}{}{}{}
		\begin{itemize}
		...
		\cventry{2017--2018}{Northern Trust}{Business Analyst}{}{}{}
		\begin{itemize}
	...
	\section{Skills}
		...
		\cvitem{\textbf{Backend}}{Python, Go, R, Java, C++}
	
		\cvitem{\textbf{Frontend}}{JavaScript, TypeScript, HTML, CSS}
	
		\cvitem{\textbf{OS}}{Windows, Debian, Alpine, ArchLinux}
	
		\cvitem{\textbf{Cloud}}{GCP, AWS, Heroku}
	
		\cvitem{\textbf{DevOps}}{Git, Docker, Kubernetes, Terraform}
	
		\cvitem{\textbf{Build}}{Jenkins, CloudBuild}
