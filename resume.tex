...
\begin{document}
	...
	\cventry{2014}{Bachelor of Science in Accounting}{Northern Illinois University}{DeKalb}{}{}

	\section{Skills}
	\ifx\resumeType\financial
		\cvitem{\textbf{Finance}}{Bloomberg Terminal/API, FactSet, Axioma Portfolio Optimizer}
	\fi
	\cvdoubleitem{\textbf{Backend}}{Python, Go, R, Java, C++}{\textbf{Frontend}}{JavaScript, TypeScript}
	...
	\cvitem{\textbf{DevOps}}{Git, Docker, Kubernetes}
\end{document}
