...
\begin{document}
	...
	\section{Skills}
	\if{\resumeType}{financial}
		\cvdoubleitem{\textbf{Backend}}{Python, R, Go, Rust, C++, Java}{\textbf{Financial}}{Bloomberg Terminal/API, FactSet, Axioma Portfolio Optimizer}
	\else
		\cvitem{\textbf{Backend}}{Python, R, Go, Rust, C++, Java}
	\fi
